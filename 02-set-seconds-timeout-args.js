...
***********************************************************************/
//Accepts a callback, a seconds delay, and any number of additional arguments.
function setSecondsTimeoutArgs(cb, delayInSeconds, ...args) {
  //The additional arguments are passed into the callback, which will run after the delay.
